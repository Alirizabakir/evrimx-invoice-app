  ...
  <div :class="widgetClasses" class="card">
    ...
    <div class="card-header border-0 py-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bold fs-3 mb-1">{{translate('trends')}}</span>

        <span class="text-muted fw-semobold fs-7">{{translate('latestTrends')}}</span>
      </h3>
      ...
      <div class="mt-5">
          ...
          <div class="d-flex align-items-center me-2">
            ...
            <div>
              <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold"
                >Top Sales</a
              >
              <div class="fs-7 text-muted fw-semobold mt-1">{{translate('pitStopEmails')}}</div>
            </div>
            <!--end::Title-->
          </div>
          <!--end::Section-->
        ...
        <div class="d-flex flex-stack">
          ...
          <div class="d-flex align-items-center me-2">
            ...
            <div class="py-1">
              <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold"
                >{{translate('topEngagement')}}</a
              >

              <div class="fs-7 text-muted fw-semobold mt-1">evrimx.com</div>
            </div>
            <!--end::Title-->
          </div>
          <!--end::Section-->
