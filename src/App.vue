...
import { initializeComponents } from "@/core/plugins/evrimxtheme";
...
@import "assets/evrimxicons/duotone/style.css";
@import "assets/evrimxicons/outline/style.css";
@import "assets/evrimxicons/solid/style.css";
