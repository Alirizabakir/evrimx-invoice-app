  ...
  <div class="w-100 p-20 bg-body rounded-start-5 rounded-end-5 shadow">
    ...
    >
      ...
      <div class="mb-10 bg-light-info p-8 rounded">
        <div class="text-info">
          {{ translate("useAccount") }} <strong>admin@demo.com</strong>
          {{ translate("andPassword") }} <strong>demo</strong>
          {{ translate("toContinue") }}.
        </div>
      </div>
      ...
      <div class="text-center">
        ...
        >
          <img
            ...
            class="h-20px me-3"
          />
          {{ translate("continue") }} {{ translate("with") }} {{ translate("google") }}
        </a>
        <!--end::Google link-->
        ...
        >
          <img
            ...
            class="h-20px me-3"
          />
          {{ translate("continue") }} {{ translate("with") }} {{ translate("facebook") }}
        </a>
        <!--end::Google link-->
        ...
        <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100">
          <img
            ...
            class="h-20px me-3"
          />
          {{ translate("continue") }} {{ translate("with") }} {{ translate("apple") }}
        </a>
        <!--end::Google link-->
      </div>
      <!--end::Actions-->
