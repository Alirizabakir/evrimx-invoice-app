<template>
  <div class="row flex-column h-100">
    <div class="d-flex align-items-center justify-content-end">
      <button :class="[status ? 'btn-primary' : 'btn-danger']" class="btn btn-sm min-w-200px mx-10" @click="status = !status">
    ...
    <div v-if="!status" class="row g-8 mt-10 overflow-auto flex-1 ">
      <div v-for="icon in KTIcon" class="col-1 mt-0 mb-8">
        <div class="card min-w-100px h-100px d-flex flex-column align-items-center justify-content-center p-2 rounded ratio-1" @mouseenter="Show = icon"
             @mouseleave="Show = ''">
    ...
    <div v-else class="row g-8 mt-10 overflow-auto flex-1 ">
      <div v-for="(icon,index) in List" class="col-1 mt-0 mb-8">
        <div class="card min-w-100px h-100px d-flex flex-column align-items-center justify-content-center p-2 rounded" @mouseenter="Show = index.toString()"
             @mouseleave="Show = ''">
